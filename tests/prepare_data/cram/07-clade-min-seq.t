...
The outputs should be subsets of the clade counts and case counts.
  ...
  Collapsing clades that have less than 50 sequence(s) in the analysis date range (inclusive) into a single 'other' clade.
  Pruning clade counts in the last 1 day(s) to exclude recent dates that may be overly enriched for variants.
  Clades that will be included: ['19A', '21J (Delta)', '21K (Omicron)', '21L (Omicron)', 'other'].
