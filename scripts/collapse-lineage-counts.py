# This script was generated by ChatGPT-4 from the prompt below.  Given this code
# is the output of ChatGPT-4 with light human revision, we do not claim copyright
# and this script is not covered by the same license as the rest of the repository.
#
# ----------------------------------------------
